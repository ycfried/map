...
-- 2. Create a private schema for helper functions
...
-- 5. Create a trigger to auto-create profile when user signs up
...
-- 7. Create an admin user (OPTIONAL - replace with your email)
